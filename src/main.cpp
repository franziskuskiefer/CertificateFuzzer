...
void set_CA_issuer() {
  ...
  oid = {2, 5, 4, 6};
  OIDManipulator m1 = OIDManipulator(derobj3, seed);
  m1.set_value(oid);
  ...
  str = "CA";
  PrintableStringManipulator m2 = PrintableStringManipulator(derobj3, seed);
  m2.set_value(str);
  ...
  oid = {2, 5, 4, 8};
  OIDManipulator m3 = OIDManipulator(derobj3, seed);
  m3.set_value(oid);
  ...
  str = "CA";
  UTF8StringManipulator m4 = UTF8StringManipulator(derobj3, seed);
  m4.set_value(str);
  ...
  oid = {2, 5, 4, 7};
  OIDManipulator m5 = OIDManipulator(derobj3, seed);
  m5.set_value(oid);
  ...
  str = "CA";
  UTF8StringManipulator m6 = UTF8StringManipulator(derobj3, seed);
  m6.set_value(str);
  ...
  oid = {2, 5, 4, 10};
  OIDManipulator m7 = OIDManipulator(derobj3, seed);
  m7.set_value(oid);
  ...
  str = "CA";
  UTF8StringManipulator m8 = UTF8StringManipulator(derobj3, seed);
  m8.set_value(str);
  ...
  oid = {2, 5, 4, 11};
  OIDManipulator m9 = OIDManipulator(derobj3, seed);
  m9.set_value(oid);
  ...
  str = "CA";
  UTF8StringManipulator m10 = UTF8StringManipulator(derobj3, seed);
  m10.set_value(str);
  ...
  oid = {2, 5, 4, 3};
  OIDManipulator m11 = OIDManipulator(derobj3, seed);
  m11.set_value(oid);
  ...
  str = "localhost";
  UTF8StringManipulator m12 = UTF8StringManipulator(derobj3, seed);
  m12.set_value(str);
  ...
  OIDManipulator m13 = OIDManipulator(derobj3, seed);
  m13.set_value(oid);
  ...
  str = "CA";
  IA5StringManipulator m14 = IA5StringManipulator(derobj3, seed);
  m14.set_value(str);
}
...
*/
string
fuzz_engine_single_field(vector<shared_ptr<DERObject>> cert_field_vector) {
  ...
  im = shared_ptr<Manipulator>(new InsertionManipulator(field, seed));
  dm = shared_ptr<Manipulator>(new DeletionManipulator(field, seed));
  cm = shared_ptr<Manipulator>(new ChangeManipulator(field, seed));
...
*/
string
fuzz_engine_multiple_fields(vector<shared_ptr<DERObject>> cert_field_vector,
...
/**
   ...
   needed)
*/
vector<shared_ptr<DERObject>>
make_cert_field_vector(shared_ptr<DERObject> node) {
...
// this should be true
shared_ptr<DERObject> parse_DER(vector<byte> input,
                                bool expand_primitives_flag = true,
  ...
  while (!finished) {
    ...
    derobj->pos = index;
  http: // lapo.it/asn1js/#

    if (!curr_top.empty()) {
      // if the index is >= the closing point of the top-node (squence or set),
      // pop it
      iterate = true;
      while (iterate) {
        iterate = false;
    ...
    if (expand_primitives_flag) {
      ...
      if (pseudo_constructed) {
        ...
        curr_top.push(
            derobj); // push to stack as would do with a real constructed type
      }
    }
...
void set_subject_alternative_names_extension() {
  ...
  IA5StringManipulator m1 = IA5StringManipulator(derobj1, seed);
  ...
  m1 = IA5StringManipulator(derobj1, seed);
  m1.set_value("localhost.");
...
void set_common_name() {
  ...
  for (shared_ptr<DERObject> derobj :
    ...
    OIDManipulator *o = new OIDManipulator(derobj->children[0]->children[0], seed);
    ...
    if (o->get_value()[0] == common_name_oid[0] &&
      ...
      m = Manipulator::make_manipulator(derobj->children[0]->children[1], seed);
      switch (int(derobj->children[0]->children[1]->raw_tag)) {
      case ASN1_TYPE_PRINTABLESTRING: {
        shared_ptr<PrintableStringManipulator> m2 =
            dynamic_pointer_cast<PrintableStringManipulator>(m);
        m2->set_value(SET_COMMONNAME);
        break;
      }

      case ASN1_TYPE_UTF8STRING: {
        shared_ptr<UTF8StringManipulator> m3 =
            dynamic_pointer_cast<UTF8StringManipulator>(m);
...
string getCert(unsigned int seed_in, const uint8_t *cert_in, size_t certLen) {
  seed = seed_in;
  cout << seed_in << endl;
  // TODO: remove
